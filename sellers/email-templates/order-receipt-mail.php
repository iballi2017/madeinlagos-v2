    ...
    <div class="container">
        <table>
            ...
            <tbody>
                <tr>
                    <td>
                        <p>Hello AKINOLA ADEDEJI, we recieved a mail from your customer: Olamide stating there is a mix
                            up in the order #123213211123345434. Kindly check the instruction, thank you. </p>
                        <p>
