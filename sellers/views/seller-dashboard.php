        ...
        <main role="main" class="container-fluid" style="overflow-x: auto">
            ...
            <div class="p-2 border border-bottom-0 py-2 px-4 rounded-top d-flex">
                ...
                <div class="dropdown ml-auto">
                    <a class="btn btn-default dropdown-toggle radio_select_option" href="#" role="button"
                        id="revenueStatus_select_option" data-toggle="dropdown" aria-haspopup="true"
                        aria-expanded="false">
                    ...
                    <div class="dropdown-menu shadow border-0 px-3" aria-labelledby="revenueStatus_select_option">
                        ...
                        <form>
                            <div class="form-check dropdown-item">
                                <input class="form-check-input" type="radio" name="revenue_duration" id="2020"
                                    value="2020">
                            ...
                            <div class="form-check dropdown-item">
                                <input class="form-check-input" type="radio" name="revenue_duration" id="2019"
                                    value="2019">
                            ...
                            <div class="form-check dropdown-item">
                                <input class="form-check-input" type="radio" name="revenue_duration" id="2018"
                                    value="2018" checked>
