...
$(document).ready(function () {
    ...
    $("#sidenav_toggler").click(function () {
        ...
        if (!$(".sidebar").hasClass("hide-list-label")) {
            ...
            if (arrowElement.hasClass("fa-arrow-alt-circle-left") && !arrowElement.hasClass("fa-arrow-alt-circle-right")) {
                arrowElement.removeClass("fa-arrow-alt-circle-left");
                arrowElement.addClass("fa-arrow-alt-circle-right");
            }
        ...
        if ($(".sidebar").hasClass("hide-list-label")) {
            ...
            if (!arrowElement.hasClass("fa-arrow-alt-circle-left") && arrowElement.hasClass("fa-arrow-alt-circle-right")) {
                $(this).children("i").removeClass("fa-arrow-alt-circle-right");
                $(this).children("i").addClass("fa-arrow-alt-circle-left");
            }
            $("sidebar").css({ "transition": "all 300ms ease-in-out" })
